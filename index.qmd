...
::: {.s21}
![](images/s21.svg){alt="A microwave transmission measurement: a flat baseline interrupted by about forty narrow resonance dips, one for each readout channel."}
:::

::: {.caption}
Each dip is one channel. Reading thousands of them on a single coaxial line is what makes
large detector arrays possible.
:::

I lead the CMB department in SLAC's Fundamental Physics Directorate, lead readout operations
for the Simons Observatory, and lead the photon sensors project in Q-NEXT's Sensors for
Entanglement thrust.
...
::: {.todo}
**TODO.** Drop the current `cv.pdf` into the repository root. The CV link above is live and
will 404 until that file is there.
:::
...
::: {.thread}
### [The first instant](research.qmd#the-first-instant)
...
CMB polarization at σ(r) = 0.001.
:::

::: {.thread}
### [How structure grew](research.qmd#how-structure-grew)
Gravitational lensing of the CMB maps all the matter between us and the last scattering
surface, whether or not it emits light. This is the Simons Observatory's territory.
:::

::: {.thread}
### [Sensing at the quantum limit](research.qmd#sensing-at-the-quantum-limit)
