...
![A transmission measurement of a resonator array on a network analyser. Each downward spike is one resonator, and one detector channel.](images/s21-trace.jpg){fig-alt="A network analyser screen showing a microwave transmission trace with dozens of sharp downward resonance dips across a frequency span of about one gigahertz."}
...
![A detector module: one hexagonal array of transition-edge sensors behind its feedhorns, with the coaxial lines that carry every channel out of the cryostat.](images/detector-module.jpg){fig-alt="Gloved hands holding a gold hexagonal detector module densely packed with hundreds of circular feedhorn apertures, with blue coaxial cables attached."}

## Beyond the CMB

Nothing about tone tracking is specific to millimetre-wave astronomy. Any experiment that
...
other. It is intended for future CMB and submillimetre surveys alongside dark matter
...
::: {.todo}
**TODO.** Add a photograph of a SMuRF crate or of the warm electronics rack. This page will
be found by people searching for the platform by name, and hardware they can recognise is
